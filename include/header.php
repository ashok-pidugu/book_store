...
<head>
    ...
    <title><?php echo $title ?? 'Online Book Store' ?></title>
...
<body>
            ...
            <div class="collapse navbar-collapse" id="topNav">
                <ul class="nav navbar-nav">
                    <?php if (isset($_SESSION['admin'])): ?>
                        <li class="nav-item"><a class="nav-link" href="admin_book.php"><span class="fa fa-th-list"></span>
                                Book List</a></li>
                    ...
                    <?php elseif (isset($_SESSION['user'])): ?>
                        <li class="nav-item"><a class="nav-link" href="user_orders.php"><span class="fa fa-th-list"></span>
                                My Orders</a></li>
                        <li class="nav-item"><a class="nav-link" href="cart.php"><span class="fa fa-shopping-cart"></span>
                                My Cart</a></li>
    ...
    <div class="container">
        <h1><?= $title ?? 'Welcome to Online Book Store' ?></h1>
        <hr>
    </div>
